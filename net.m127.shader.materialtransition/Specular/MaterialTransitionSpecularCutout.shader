Shader "Megacrafter127/MaterialTransition(Specular,Cutout)"
{
    Properties
    {
        //Mat1
        ...
        _SpecColor("Specular", Color) = (.5,.5,.5,1)
        ...
        _SpecColor2("Specular", Color) = (.5,.5,.5,1)
    ...
    CustomEditor "M127.SpecularMaterialTransitionShaderGUI"
    SubShader
    {
        ...
        #pragma surface surf StandardSpecular fullforwardshadows noinstancing alphatest:_Cutoff
...
#include "../matTrans.cginc"
        ...
        void surf (Input IN, inout SurfaceOutputStandardSpecular o)
        {
            ...
            float4 m = tex2D(_SpecGlossMap, IN.uv_SpecGlossMap);
            float4 m2 = tex2D(_SpecGlossMap2, IN.uv_SpecGlossMap2);
            o.Specular = lerp(m.rgb * _SpecColor.rgb, m2.rgb * _SpecColor2.rgb, grad);
